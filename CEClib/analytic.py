...
def lambda_gg(Egamma=1e3,z=0): # Egamma (GeV)
   ...
   E_tab = loadtxt("Results/Absorption/lambda_e.dat",unpack=True,usecols=[0])*me*1e-6
   ...
   lambda_e = loadtxt("Results/Absorption/lambda_e.dat",unpack=True,usecols=[i1+1,i2+1,i1+7,i2+7])
...
def Ecut(z=0.14): # TeV
   zi,ctgg,best_fit,dominguez,finke,franceschini,gilmore,lower_limit = loadtxt("Results/Absorption/Ecut.dat",unpack=True,usecols=[0,1,2,3,4,5,6,7]) 
